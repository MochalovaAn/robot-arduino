...
После подключения к WiFi точке доступа робота автоматически откроется Web-страница управления. Если страница управления не открылась автоматически или открылась страница поиска msn, запустите браузер и в адресной строке введите `http://172.16.0.1`.
...
- `speed` - Задать скорость вращения. Параметр - значение скорости, шагов в секунду. Разрешается меять скорость _на ходу_ во время вращения двигателя.

- `acceleration` - Задать ускорение. Параметр - значение ускорения, шагов в секунду за секунду.
...
Получение параметров и состояния шагового двигателя.
...
Установка параметров вращения шагового двигателя.
...
Получение параметров гироскопа.
...
- `status` - Изменение текущего состояние робота.
